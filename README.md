...
Colors:
- Red - Inaccessible
- Blue - Inspect (can see, but either is information only, or an item you can't collect yet)
- Yellow - Can reach out of logic (using tricks of higher difficulty, or using keys before you logically have enough)
- Green - Can reach
