...
DungeonImageDict = {
	[0] = {"images/labels/DX_unknown.png", "images/labels/DX_unknown.png", "images/labels/DX_unknown_alert.png", "images/labels/DX_unknown_alert.png"},
	[1] = {"images/labels/d0_entrance.png", "images/labels/d0_entrance_alt.png", "images/labels/d0_entrance_alert.png", "images/labels/d0_entrance_alt_alert.png"},
	[2] = {"images/labels/LC_entrance.png", "images/labels/LC_entrance_alt.png", "images/labels/LC_entrance_alert.png", "images/labels/LC_entrance_alt_alert.png"},
	[3] = {"images/labels/D1_entrance.png", "images/labels/D1_entrance_alt.png", "images/labels/D1_entrance_alert.png", "images/labels/D1_entrance_alt_alert.png"},
	[4] = {"images/labels/D2_entrance.png", "images/labels/D2_entrance_alt.png", "images/labels/D2_entrance_alert.png", "images/labels/D2_entrance_alt_alert.png"},
	[5] = {"images/labels/D3_entrance.png", "images/labels/D3_entrance_alt.png", "images/labels/D3_entrance_alert.png", "images/labels/D3_entrance_alt_alert.png"},
	[6] = {"images/labels/D4_entrance.png", "images/labels/D4_entrance_alt.png", "images/labels/D4_entrance_alert.png", "images/labels/D4_entrance_alt_alert.png"},
	[7] = {"images/labels/D5_entrance.png", "images/labels/D5_entrance_alt.png", "images/labels/D5_entrance_alert.png", "images/labels/D5_entrance_alt_alert.png"},
	[8] = {"images/labels/D6_entrance.png", "images/labels/D6_entrance_alt.png", "images/labels/D6_entrance_alert.png", "images/labels/D6_entrance_alt_alert.png"},
	[9] = {"images/labels/D7_entrance.png", "images/labels/D7_entrance_alt.png", "images/labels/D7_entrance_alert.png", "images/labels/D7_entrance_alt_alert.png"},
	[10] = {"images/labels/D8_entrance.png", "images/labels/D8_entrance_alt.png", "images/labels/D8_entrance_alert.png", "images/labels/D8_entrance_alt_alert.png"}
}
DungeonLocationDict = {
	[0] = {
	...
	[11] = {
		"@Hero's Cave (Linked)/Alternative Entrance Chest/",
		"@Hero's Cave (Linked)/First Reward/1F",
		"@Hero's Cave (Linked)/Checkerboard Drop/2F",
		"@Hero's Cave (Linked)/Second Reward/2F",
		"@Hero's Cave (Linked)/Torch Chest/3F",
		"@Hero's Cave (Linked)/Flooded Room Drop/3F",
		"@Hero's Cave (Linked)/Third Reward/3F",
		"@Hero's Cave (Linked)/Fourth Reward/4F",
		"@Hero's Cave (Linked)/Gauntlet/5F",
		"@Hero's Cave (Linked)/Boomerang Maze/5F",
		"@Hero's Cave (Linked)/Final Reward/",
	},
	[1] = {
		...
		"@Gnarled Root Dungeon/Boss Reward/Aquamentus",
		"@Gnarled Root Dungeon/Fertile Soil/Essence",
	},
	[2] = {
		...
		"@Snake's Remains/Wild Bombs (Hardhat)/",
		...
		"@Snake's Remains/Wild Bombs (Pol's Voice)/",
		"@Snake's Remains/Chest on Terrace/",
		"@Snake's Remains/Boss Reward/King Dodongo",
		"@Snake's Remains/Gift of Time/Essence",
	},
	[3] = {
		"@Poison Moth's Lair/Chest in Watery Room/B1F",
		"@Poison Moth's Lair/Chest Above West Trampoline & Owl/1F",
		"@Poison Moth's Lair/Chest Above East Trampoline/1F",
		"@Poison Moth's Lair/Chest in Roller Room/B1F",
		"@Poison Moth's Lair/Chest in Moldorm Room/1F",
		"@Poison Moth's Lair/Chest in Room Behind Hidden Cracked Wall/1F",
		"@Poison Moth's Lair/Chest in Mimics Room/1F",
		"@Poison Moth's Lair/Chest on Quicksand Terrace/B1F",
		"@Poison Moth's Lair/Chest in Moving Blade Room/B1F",
		"@Poison Moth's Lair/Boss Reward/Mothula",
		"@Poison Moth's Lair/Bright Sun/Essence",
	},
	[4] = {
		"@Dancing Dragon Dungeon/Chest North of Entrance/2F",
		"@Dancing Dragon Dungeon/Pots on Buttons Puzzle Drop/2F",
		"@Dancing Dragon Dungeon/Chest in Southwest Quadrant of Beamos Room/1F",
		"@Dancing Dragon Dungeon/Dark Room Chest/1F",
		"@Dancing Dragon Dungeon/Chest in Water Donut Room/2F",
		"@Dancing Dragon Dungeon/Pool Drop/2F",
		"@Dancing Dragon Dungeon/Chest on Small Terrace/1F",
		"@Dancing Dragon Dungeon/Business Scrub/1F",
		"@Dancing Dragon Dungeon/Chest Revealed by Minecart Torches/1F",
		"@Dancing Dragon Dungeon/Wild Ember Seeds/1F",
		"@Dancing Dragon Dungeon/Crumbling Room Chest/1F",
		"@Dancing Dragon Dungeon/Eye Diving Spot Item/1F",
		"@Dancing Dragon Dungeon/Boss Reward/Gohma",
		"@Dancing Dragon Dungeon/Soothing Rain/Essence",
	},
	[5] = {
		...
		"@Unicorn's Cave/Armos Puzzle Room/Item",
		...
		"@Unicorn's Cave/Boss Reward/Digdogger",
		"@Unicorn's Cave/Nurturing Warmth/Essence",
	},
	[6] = {
		"@Ancient Ruins/Crumbling Ground Room Chest/1F",
		"@Ancient Ruins/Magnet Ball Puzzle Drop/1F",
		"@Ancient Ruins/Chest in Beamos Room/1F",
		"@Ancient Ruins/Chest in Gibdo Room/2F",
		"@Ancient Ruins/Chest Between 4 Armos/2F",
		"@Ancient Ruins/Armos Hall Chest/3F",
		"@Ancient Ruins/Chest North of Main Spinner/2F",
		"@Ancient Ruins/Chest on Terrace Left of Entrance/1F",
		"@Ancient Ruins/Crystal Maze Room Chest/1F",
		"@Ancient Ruins/Chest After Time Trial/2F",
		"@Ancient Ruins/Chest on Red Terrace Before Vire/2F",
		"@Ancient Ruins/Boss Reward/Manhandla",
		"@Ancient Ruins/Blowing Wind/Essence",
	},
	[7] = {
		"@Explorer's Crypt/Wild Ember Seeds/1F",
		"@Explorer's Crypt/Chest Behind Cracked Wall/1F",
		"@Explorer's Crypt/Chest in Wizzrobe Room/1F",
		"@Explorer's Crypt/Chest Right of Entrance/1F",
		"@Explorer's Crypt/Zol Button Drop/B1F",
		"@Explorer's Crypt/Armos Puzzle Drop/B2F",
		"@Explorer's Crypt/Chest Connected to Magnet Ball Button/B1F",
		"@Explorer's Crypt/Quicksand Chest Near Second Poe/1F",
		"@Explorer's Crypt/Fast Moving Platform Chest/B1F",
		"@Explorer's Crypt/Stair Maze Chest/B2F",
		"@Explorer's Crypt/Drop in Room North of Stair Maze/B2F",
		"@Explorer's Crypt/Jumping Stalfos Room Chest/B1F",
		"@Explorer's Crypt/Boss Reward/Gleeok",
		"@Explorer's Crypt/Seed of Life/Essence",
	},
	[8] = {
		"@Sword and Shield Maze/Eye Drop Near Entrance/1F",
		"@Sword and Shield Maze/Three Eyes Chest/1F",
		"@Sword and Shield Maze/Drop in Hardhat & Magnet Ball Room/1F",
		"@Sword and Shield Maze/U-shaped Spiky Freezer Chest/1F",
		"@Sword and Shield Maze/Bottom Chest in Lava Bridge Room/1F",
		"@Sword and Shield Maze/Top Chest in Lava Bridge Room/1F",
		"@Sword and Shield Maze/Chest Right of Spinner/B1F",
		"@Sword and Shield Maze/Chest in Bombable Blocks Room/1F",
		"@Sword and Shield Maze/Wild Mystery Seeds/B1F",
		"@Sword and Shield Maze/Chest on Terrace After Pols Voice Room/1F",
		"@Sword and Shield Maze/Ghost Armos Puzzle Drop/1F",
		"@Sword and Shield Maze/Southeast Lava Chest/B1F",
		"@Sword and Shield Maze/Chest in Sparks & Pots Room/1F",
		"@Sword and Shield Maze/Southwest Lava Chest/B1F",
		"@Sword and Shield Maze/Boss Reward/Medusa Head",
		"@Sword and Shield Maze/Changing Seasons/Essence",
	}
}
